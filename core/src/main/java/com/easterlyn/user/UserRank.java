...
public enum UserRank {
  ...
  DANGER_DANGER_HIGH_VOLTAGE(
      "ask.adam.before.touching",
      HEAD_ADMIN.friendlyName,
      PermissionDefault.FALSE,
      HEAD_ADMIN.colorSupplier);
  ...
  UserRank(
      String internalName, PermissionDefault permissionDefault, Supplier<ChatColor> colorSupplier) {
    this(
        internalName,
        Character.toUpperCase(internalName.charAt(0)) + internalName.substring(1),
        permissionDefault,
        colorSupplier);
  }
  ...
  UserRank(
      ...
      Supplier<ChatColor> colorSupplier) {
