...
public class EasterlynLocales extends BukkitLocales {
	...
	private static final Pattern I18N_STRING = Pattern.compile("\\{@@(?<key>.+?)}", Pattern.CASE_INSENSITIVE);
	...
	@Override
	public @Nullable String getMessage(@NotNull CommandIssuer issuer, @NotNull MessageKeyProvider key) {
