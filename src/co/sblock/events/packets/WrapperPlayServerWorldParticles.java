...
public class WrapperPlayServerWorldParticles extends AbstractPacket {
	 ...
	 */
	public WrapperPlayServerWorldParticles(ParticleEffect effect, int count, Location location,
			Vector offset) {
		this();
	...
	/**
	 * Set the random offset (multiplied by a random gaussian) to be applied after the particles are
	 * created.
	 * 
	...
	/**
	 * Retrieve the random offset that will be multiplied by a random gaussian and applied to each
	 * created particle.
	 * 
