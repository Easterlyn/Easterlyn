...
public class WrapperPlayServerOpenWindow extends AbstractPacket {
	...
	private static List<InventoryType> inventoryByID = Arrays.asList(InventoryType.CHEST,
			InventoryType.WORKBENCH, InventoryType.FURNACE, InventoryType.DISPENSER,
			InventoryType.ENCHANTING, InventoryType.BREWING, InventoryType.MERCHANT,
			InventoryType.BEACON, InventoryType.ANVIL);
	...
	/**
	 * Set a unique id number for the window to be displayed. Notchian server implementation is a
	 ...
	 * <p>
	 * If false, the client will look up a string like "window.minecart". If true, the client uses
