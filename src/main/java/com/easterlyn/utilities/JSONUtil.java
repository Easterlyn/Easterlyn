...
public class JSONUtil {
	...
	private static String getItemText(net.minecraft.server.v1_15_R1.ItemStack item) {
		return item.save(new NBTTagCompound()).toString();
	}

	private static HoverEvent getItemHover(net.minecraft.server.v1_15_R1.ItemStack item) {
