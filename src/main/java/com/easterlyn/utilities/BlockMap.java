...
public class BlockMap<V> {
	...
	public @Nullable
    V put(@NotNull Block block, @Nullable V value) {
	...
	public @NotNull
    Collection<V> get(@NotNull Chunk chunk) {
		return get(chunk.getWorld().getName(), chunk.getX(), chunk.getZ());
	}

	public @NotNull
    Collection<V> get(@NotNull String world, int chunkX, int chunkZ) {
	...
	public @NotNull
    Collection<V> remove(@NotNull Chunk chunk) {
		return remove(chunk.getWorld().getName(), chunk.getX(), chunk.getZ());
	}

	public @NotNull
    Collection<V> remove(@NotNull String world, int chunkX, int chunkZ) {
		List<V> values = new ArrayList<>();
