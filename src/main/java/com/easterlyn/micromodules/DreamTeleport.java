...
import com.easterlyn.events.packets.SleepTeleport;
import com.easterlyn.events.packets.WrapperPlayServerAnimation;
import com.easterlyn.events.packets.WrapperPlayServerBed;
...
public class DreamTeleport extends Module {
	...
	public DreamTeleport(Easterlyn plugin) {
		super(plugin);
