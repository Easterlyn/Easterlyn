...
public abstract class Effect {
	...
	protected Effect(@NotNull EasterlynEffects plugin, @NotNull String name, @NotNull Function<EquipmentSlot, Boolean> target,
			double cost, int maximumLevel, int maximumCombinedLevel) {
		this.plugin = plugin;
		this.name = name;
		this.target = target;
		this.cost = cost;
	 ...
	 */
	@NotNull
	public Function<EquipmentSlot, Boolean> getTarget() {
		return target;
	}
	 ...
	 */
	@NotNull
	public EasterlynEffects getPlugin() {
		return this.plugin;
	}
