...
public class EquipmentSlots {
  ...
  public static final Function<EquipmentSlot, Boolean> TOOL =
      equipmentSlot -> equipmentSlot == EquipmentSlot.HAND;
  public static final Function<EquipmentSlot, Boolean> HELD =
      equipmentSlot ->
          equipmentSlot == EquipmentSlot.HAND || equipmentSlot == EquipmentSlot.OFF_HAND;
  public static final Function<EquipmentSlot, Boolean> ARMOR =
      equipmentSlot ->
          equipmentSlot == EquipmentSlot.HEAD
              || equipmentSlot == EquipmentSlot.CHEST
              || equipmentSlot == EquipmentSlot.LEGS
              || equipmentSlot == EquipmentSlot.FEET;
  public static final Function<EquipmentSlot, Boolean> HEAD =
      equipmentSlot -> equipmentSlot == EquipmentSlot.HEAD;
  public static final Function<EquipmentSlot, Boolean> FEET =
